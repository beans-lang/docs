      ...
      sidebar: [
        ...
        },
        {
          ...
          items: [
            ...
            { label: 'Fibers and brew', slug: 'guide/fibers' },
        ...
        },
        {
          ...
          items: [
            ...
            { label: 'std.http', slug: 'reference/stdlib/http' },
            { label: 'std.websocket', slug: 'reference/stdlib/websocket' },
            { label: 'std.tls', slug: 'reference/stdlib/tls' },
            { label: 'std.crypto', slug: 'reference/stdlib/crypto' },
            { label: 'std.compress', slug: 'reference/stdlib/compress' },

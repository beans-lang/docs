...
```text
beansc 0.1.39 (language 1.0, runtime ABI 16)
```

This tells you three things: the compiler version (`0.1.39`), the language
contract it implements (`1.0`), and the runtime ABI (`16`).

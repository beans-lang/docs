...
```text
beansc 0.1.30 (language 1.0, runtime ABI 10)
```

This tells you three things: the compiler version (`0.1.30`), the language
contract it implements (`1.0`), and the runtime ABI (`10`).
